...
ggplot2::ggplot(sampleSize2, ggplot2::aes(x = probs, y = N))+
  ...
  ggplot2::facet_wrap(~delta + group)
   
tmp <- sampleSize2 |> tidyr::pivot_wider(id_cols = c("probs","sdtrimmed", "group"), names_from =  delta, values_from = N  )
tmp
