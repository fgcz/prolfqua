...
output:
  ...
  bookdown::pdf_document2:
    ...
    toc_depth: 2
params:
  configuration:  !r parse(text="data('data_ionstar');data_ionstar$filtered()$config$clone(deep=TRUE)" )
  project_conf: NULL
  data: !r parse(text="data('data_ionstar');prolfqua::data_ionstar$filtered()$data")
  plot_density: TRUE
...
ggplot(sampleSize$long, aes(x = quantile, y = N)) +
  ...
  geom_text(aes(label = N), nudge_y = nudgeval) + 
  facet_wrap(~ paste0("FC==", round(FC,digits=2), "~or~log[2](FC)==", delta), 
