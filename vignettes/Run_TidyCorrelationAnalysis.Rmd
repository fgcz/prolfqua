...
#'
data <- LFQServiceData::spectronautDIAData250
xx <-  LFQServiceData::spectronautDIAData250_config
#'
...
#'
spectronautDIAData250_A <- list(data = LFQServiceData::spectronautDIAData250, config_f =specnautconfig, analysis=setup )
...
if(0){
  ...
  longFormat <- longFormat %>% select(all_of( "PG.ProteinAccessions", ))
  spectronautDIAData250 <- longFormat
  unique(spectronautDIAData250$R.FileName)
  unique(spectronautDIAData250$PG.ProteinAccessions)
...
```{r}
longFormat <- LFQServiceData::spectronautDIAData250_A$data
