...
This vignette describes how `correlation filtering` is used to remove uncorrelated precursors or peptides from the data.
...
For Spectronaut data QValue filtering can be performed using thersholds specified in the configuration.
...
Then we remove precrusors that do not pass the  `qVal_experiment_threshold`.
