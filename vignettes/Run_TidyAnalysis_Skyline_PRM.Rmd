...
figs <- xnested %>% mutate(plot = map2(data, UQ(proteinIDsymbol) , plot_hierarchies_line, skylineconfig))
...
figs3 <- figs3 %>% mutate(plotlog = map2(data, UQ(proteinIDsymbol) , plot_hierarchies_line, skylineconfig))
plot_hierarchies_add_quantline(figs3$plotlog[[1]], figs3$medpolishPly[[1]], "medpolish", skylineconfig)

figs3 <- figs3 %>% mutate(figsMed = map2(plotlog, medpolishPly, plot_hierarchies_add_quantline, "medpolish" , skylineconfig ))
