...
First we remove 0 intensity values, then filter for 2 peptides per protein.
...
```{r contrastImputed}
contrImp <- prolfqua::ContrastsSimpleImpute$new(protLFQ, relevantContrasts, global = FALSE)
