...
vignette: >
  %\VignetteIndexEntry{Bioinformatics Project Meeting}
...
- [ ] [WebGestalt](http://www.webgestalt.org/) (WEB-based GEne SeT AnaLysis Toolkit)
- [ ] [string-db](https://string-db.org/) (Known and predicted protein-protein interactions)
- other : 
...
- The identifiers in the protein database should be compatible with the downstream analysis tool you intend to use. For instance _WebGestaltR_, although it recognizes many types of identifiers: e.g., Uniprot Swiss-Prot, Gene Symbols, NCBI Entrez gene it does not work with Uniprot Treml identifiers.



Which sequence database should be used for protein identification? (A list of available FGCZ databases)[http://fgcz-r-021.uzh.ch/FASTA/]
...
Level names (_camel case_ e.g. Control, Massage, Creme): 
