...
benchmark_msstats$smc$summary

res <- benchmark_msstats$pAUC_summaries()
undebug(prolfqua:::.partial_AUC_summary)
undebug(prolfqua:::.scale_probabilities)
benchmark_msstats$plot_FDRvsFDP()
benchmark_msstats$plot_FDPvsTPR()
benchmark_msstats$plot_ROC()
