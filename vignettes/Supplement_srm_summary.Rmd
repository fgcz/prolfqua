...
params:
  configuration:  !r quote(prolfqua::data_skylinePRMSample_A$config_f())
  data: !r quote(prolfqua::data_skylinePRMSample_A$analysis(prolfqua::data_skylinePRMSample_A$data, prolfqua::data_skylinePRMSample_A$config_f()))
vignette: >
