...
```{r prepForGSEA}
evalAll <- requireNamespace("clusterProfiler", quietly = TRUE) &
  requireNamespace("org.Sc.sgd.db", quietly = TRUE) &
  requireNamespace("prora", quietly = TRUE)
...
enrichplot::ridgeplot( res )
```

```{r dotplot, fig.cap = "Dotplot", eval = evalAll}
enrichplot::dotplot(res , showCategory = 30)
```
