...
proteinIDsymbol <- rlang::sym(skylineconfig$table$hierarchyKeys()[1])
...
skylineconfigHL$table$get_work_intensity()
...
HLfigs3 <- HLfigs3 |>
  dplyr::mutate(figsMed = purrr::map2(plot, medpolishPly, plot_hierarchies_add_quantline, "medpolish", skylineconfig))
