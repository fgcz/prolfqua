...
```{r plot_sd_ecdf, fig.cap="Empirical cumulative density function of the standard deviation for all the proteins in the dataset."}
...
```{r plot_sample_size_quantiles, fig.cap="Estimated sample sizes for various FC levels and various quantiles of the standard deviation."}
sampleSize |>
