...
#' x1 <- compute_anova_lm(data, config, hierarchy_level= 2, factor_level=1)
#' x2 <- compute_anova_lm(data, config, hierarchy_level = 1, factor_level=2)
#' x3 <- compute_anova_lm(data, config, hierarchy_level= 2, factor_level=2)
#' (head(x1))
