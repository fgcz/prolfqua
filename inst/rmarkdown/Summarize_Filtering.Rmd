...
hcs <- hierarchy_counts_sample(params$resDataStart, params$config_resDataStart)("wide")
...
print(plot_NA_heatmap(params$removed_peptides, results$config_resDataStart)$plot)
```
