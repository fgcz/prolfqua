...
ftab <- flextable::flextable(cv_quantiles_res) %>%
  flextable::autofit() %>%
  flextable::set_caption("Summary of the coefficient of variation (CV) at the 50th, 60th, 70th, 80th and 90th percentile.")
ftab
