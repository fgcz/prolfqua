...
For interpreting the results, the protein Id's can be either sorted by the fold change estimates or `p.value`. Large positive or negative fold changes typically result in small p-values therefore we suggest sorting by foldchange.
