...
output:
  ...
  bookdown::html_document2:
    ...
    toc_depth: 2
params:
  configuration:  !r quote(LFQServiceData::skylinePRMSampleData_A$config_f())
  data: !r quote(LFQServiceData::skylinePRMSampleData_A$analysis(LFQServiceData::skylinePRMSampleData_A$data, LFQServiceData::skylinePRMSampleData_A$config_f()))
  plot_density: TRUE
...
show_text <- !local_config$table$is_intensity_transformed
