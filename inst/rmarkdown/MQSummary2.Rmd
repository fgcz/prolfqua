...
if (length(samples) > 10) {
  ...
  LFQService::mypairsSmooth( toWideConfig(ldata, local_config, as.matrix = TRUE)$data )
}else{
  LFQService::mypairsSmooth( toWideConfig(dataTransformed, local_config, as.matrix = TRUE)$data )
}
```
