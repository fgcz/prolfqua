...
```{r hierarchyCounts, results="asis"}
...
```{r sampleNameRawFileMapping, results="asis"}
knitr::kable(table_factors(data, local_config), 
             caption = "Mapping of raw file names to sample names used throughout this report.", format="html") 
```

```{r hierarchyCountsSample}
caption <- paste("Number of quantified ", if(params$pep){"peptides and proteins"}else{"peptides"}, " per sample.")
knitr::kable(hierarchy_counts_sample(dataTransformed, configuration = local_config)("wide"),
             caption = caption ) 
```
