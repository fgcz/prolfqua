...
if (length(samples) > 10) {
  ...
  LFQService::pairsSmooth( toWideConfig(ldata, local_config, as.matrix = TRUE)$data )
}else{
  LFQService::pairsSmooth( toWideConfig(dataTransformed, local_config, as.matrix = TRUE)$data )
}
```
