...
paste("Figure \@ref(fig:imputedProt) shows Proteins for which we used missing value imputation because there are no observation in one of the conditions.",
"The missing group average we substitute by the mean of 10% smallest protein group averages in the dataset.")
