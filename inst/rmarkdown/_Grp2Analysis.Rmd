...
paste("Furthermore, figure \@ref(fig:siproteins) shows a heatmap of proteins with the FDR < ", grp2$FDRthreshold ," and diff > ",  grp2$log2FCthreshold)
paste("Figure \@ref(fig:boxplot) shows the boxplots of ", nrb, " significant proteins.")

```


(ref:siproteins) Heatmap showing proteins with FDR < `r grp$FDRthreshold` and diff > `r  grp2$log2FCthreshold`.
