...
conMI <- ContrastsModerated$new(mC, modelName = "ModeratedImpute")
...
top20 <- tmp2 %>% dplyr::select( protein_Id,log2FC= estimate,conf.low,conf.high, FDR ) %>% arrange(FDR) %>% head(20)
GRP2$top20 <- top20
