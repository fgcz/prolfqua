...
x <- data.frame(table(abs(grp2$contrMerged$contrastDF$estimate) >  grp2$log2FCthreshold  & grp2$contrMerged$contrastDF$FDR < grp2$FDRthreshold))
...
significant <- grp2$contrMerged$contrastDF %>% dplyr::filter(FDR < grp2$FDRthreshold & abs(estimate) > grp2$log2FCthreshold )
