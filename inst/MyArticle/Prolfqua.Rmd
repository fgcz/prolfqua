...
abstract: We introduce here the R package and benchmark the suitability of linear modelling methods available in R for label free protein expression analysis.
