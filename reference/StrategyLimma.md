...
but for limma's matrix-based pipeline. Consumed by
...
- [`StrategyLimma$new()`](#method-StrategyLimma-new)

- [`StrategyLimma$clone()`](#method-StrategyLimma-clone)
