...
res$boxplot[[1]]
#> Warning: Removed 143 rows containing non-finite outside the scale range (`stat_boxplot()`).
#> Warning: Removed 143 rows containing non-finite outside the scale range (`stat_summary()`).
#> Warning: Removed 143 rows containing non-finite outside the scale range (`stat_summary()`).
#> Warning: Removed 143 rows containing missing values or values outside the scale range (`position_quasirandom()`).
